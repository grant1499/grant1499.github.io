...
![image-20210527154520270](蓝桥杯学习总结（二十）/image-20210527154520270.png)
...
![image-20210527212154148](蓝桥杯学习总结（二十）/image-20210527212154148.png)

注意爆int。

满二叉树的深度为log(1e5) 最多可以有 1 << (log(1e5)) - 1个元素 大概是2^15 ~ 2^16 ，再乘以一个 1e5 所以
...
![image-20210528202135319](蓝桥杯学习总结（二十）/image-20210528202135319.png)
