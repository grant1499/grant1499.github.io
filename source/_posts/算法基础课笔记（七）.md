...
题解2：idx初试化为1，让位置0作为头结点，这样就可以把所有操作统一了。
...
![image-20210806212205027](算法基础课笔记（七）/image-20210806212205027.png)

插入与删除操作：

![image-20210806212258184](算法基础课笔记（七）/image-20210806212258184.png)
