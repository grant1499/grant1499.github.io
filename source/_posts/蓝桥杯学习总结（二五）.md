...
![image-20210606191703653](蓝桥杯学习总结（二五）/image-20210606191703653.png)
...
前缀和只能查询，复杂度为O(1)，但是不支持修改。

树状数组的定义：树状数组是**一维**的！！！

![image-20210606194200602](蓝桥杯学习总结（二五）/image-20210606194200602.png)
...
![image-20210607085405626](蓝桥杯学习总结（二五）/image-20210607085405626.png)
...
![image-20210607090931297](蓝桥杯学习总结（二五）/image-20210607090931297.png)
