...
Java标准库自带的`java.util`包提供了集合类。

![image-20210503103116117](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232118073.png)

这两个都是接口，不是类。

Collection的接口继承树：

![image-20210503103324545](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232118439.png)

Map的接口继承树：

![image-20210503103348318](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117832.png)
...
![image-20210503103440883](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117233.png)
...
向Collection接口的实现类的对象中添加数据obj时，要求重写`equals()`，因为contains方法会调用equals。
...
![image-20210611193315961](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117118.png)

迭代器的执行原理：

![image-20210611194015297](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117648.png)
...
![image-20210611195203094](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117853.png)
...
![image-20211209092627911](https://gitee.com/grant1499/blog-pic/raw/master/img/202112090926019.png)
...
![image-20210612090751182](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232117640.png)
...
第一种是调用`toArray()`方法直接返回一个`Object[]`数组。（前面有例子）
