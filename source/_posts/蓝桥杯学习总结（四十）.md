...
参考题解：https://www.cnblogs.com/JVxie/p/4854719.html。（有图来模拟详细过程）
...
![image-20210708214906658](蓝桥杯学习总结（四十）/image-20210708214906658.png)
...
![image-20210718191124541](蓝桥杯学习总结（四十）/image-20210718191124541.png)
...
int main(){
    ...
    while (n--){
        ...
        if (*op == 'I') h[k] = x;// 返回空位，插入x
            ...
            if (h[k] != null) puts("Yes");// 返回空位说明没找到x
            else puts("No");
        }
    } 
    return 0;
