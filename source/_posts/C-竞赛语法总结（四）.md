...
![image-20210116183048237](C-竞赛语法总结（四）/image-20210116183048237.png)
...
![image-20210117092853170](C-竞赛语法总结（四）/image-20210117092853170.png)

empty函数：测试string是否为空（即长度是否为0），如果为空，输出1，否则输出0.这里的1,0代表真假。

size函数：求string长度，不像strlen函数会进行循环，它的时间复杂度是O(1)，很快。

![image-20210117093630721](C-竞赛语法总结（四）/image-20210117093630721.png)

`s4 = s1 + “asdafd” + ‘s’;// 这种也是支持的`

![image-20210117094315743](C-竞赛语法总结（四）/image-20210117094315743.png)
...
![image-20210117094823940](C-竞赛语法总结（四）/image-20210117094823940.png)
