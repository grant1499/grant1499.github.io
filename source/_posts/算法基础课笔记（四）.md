...
其实上面代码只需要一个`b[N]`数组就可以，差分数组初始化只要读入`int x`就行，不需要另外的数组。
...
![image-20210613220956311](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232003769.png)
...
![image-20210804214908224](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232004662.png)
