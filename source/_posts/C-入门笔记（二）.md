...
![image-20210203143637716](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232015113.png)
...
![image-20210203145400561](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232016197.png)


![image-20210203145500712](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232016603.png)
...
![image-20210203150448563](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232016081.png)
...
![image-20210203150758714](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232016861.png)
...
![image-20210203151526209](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232016699.png)
...
![image-20210203154639070](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232018869.png)


![image-20210203154703412](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017146.png)
...
![image-20210204210411325](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017037.png)


![image-20210204210603157](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232018480.png)


如果类中没有写构造函数，编译器会自动生成一个隐含的默认构造函数，该构造函数的参数列表和函数体皆为空。

![image-20210204211618472](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017078.png)


![image-20210204211726359](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017182.png)

### **构造函数初始化列表**

构造函数初始化列表以一个冒号开始，接着是以逗号分隔的数据成员列表，每个数据成员后面跟一个放在括号中的初始化式。

**对于const修饰的数据成员和引用类型的数据成员，不允许直接用赋值语句赋值**，只能通过构造函数的初始化列表进行初始化。
...
![image-20210204220622695](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017100.png)

### 复制构造函数

系统会自动生成一个默认的复制构造函数，复制出完全相同的新对象。

![image-20210204221028604](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017550.png)

我们只能使用这里的引用进行复制，而不让它对指向的对象进行修改。

这样既能传参又能保证安全性。

![image-20210204221610258](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017300.png)


![image-20210204221758899](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017070.png)


![image-20210204222349707](https://gitee.com/grant1499/blog-pic/raw/master/img/202110232017938.png)
